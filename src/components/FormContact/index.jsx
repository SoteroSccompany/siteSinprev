...
export default function FormContact() {
  ...
  return (
    <div className="overflow-hidden bg-gray-100 py-16 px-4 sm:px-6 lg:px-8 lg:py-24">
      <div className="relative mx-auto max-w-xl">
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Em caso de duvida, entre em contato conosco!</h2>
        </div>
        <div className="mt-12">
