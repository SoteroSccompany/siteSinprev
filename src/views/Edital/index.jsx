...
const edital = () => {
    window.location.href = 'https://sinprev.com.br/20220525-edital-de-convocacao-de-age.pdf'
}
    ...
    return (
        <div>
            ...
            <div className="flex flex-col justify-center items-center p-[67px] bg-[url('https://sinprev.com.br/images/bg-afiliese-copy-1.webp')]">
                <h1 className="flex sm:flex-row  flex-col items-center junstify-center font-['Be Vietnam Bold'] font-bold mr-6 sm:mr[0%] text-white text-[45px] sm:text-[25px] w-full sm:w-[22%]">Editais de <span className="ml-4">Convocação</span></h1>
            ...
            <div className="flex flex-col items-center p-[50px] pb-[50px] bg-[#0000]">
                <h1 className=" font-['Be Vietnam Bold'] text-center mr-6 sm:mr-[0%]">Nesta página, você associado tem acesso aos editais de convocação para as eleições e assembléias gerais.</h1>
                <div className="flex flex-col sm:flex-row">
                    <button className="flex items-center mt-16 flex-col mr-[19%] sm:mr-[4%]" onClick={edital}>
                        <img src="https://sinprev.com.br/images/pdf-copy-2.webp" className="sm:w-[30%] w-[50%]" alt="" />
                        <p className="font-['Poppins-Semi Bold']  sm:text-[24px] text-[18px]  text-[#666666] mt-6 ">Edital de convocação de AGE</p>
